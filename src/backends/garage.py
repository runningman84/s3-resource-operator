...
class Garage(Backend):
    ...
    def bucket_exists(self, bucket_name):
        logger.info(f"[Garage DUMMY] Would check if bucket '{bucket_name}' exists.")
        raise NotImplementedError

    def get_bucket_owner(self, bucket_name):
        logger.info(f"[Garage DUMMY] Would get owner of bucket '{bucket_name}'.")
        raise NotImplementedError

    def change_bucket_owner(self, bucket_name, new_owner):
        logger.info(f"[Garage DUMMY] Would change owner of bucket '{bucket_name}' to '{new_owner}'.")
        raise NotImplementedError
    ...
    def user_exists(self, access_key):
        logger.info(f"[Garage DUMMY] Would check if user '{access_key}' exists.")
        raise NotImplementedError