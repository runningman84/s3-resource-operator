...
*/}}
{{- define "s3-resource-operator.chart" -}}
...
helm.sh/chart: {{ include "s3-resource-operator.chart" . }}
{{ include "s3-resource-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "s3-resource-operator.secretName" -}}
