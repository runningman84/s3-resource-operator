...
gh release download v1.13.2 --pattern 'sbom-*.json'

# Download vulnerability reports
gh release download v1.13.2 --pattern 'vulnerability-report*'
```
...
4. **Result**: New version available within minutes at:
   - Docker: `ghcr.io/runningman84/s3-resource-operator:1.13.2`
   - Helm: `oci://ghcr.io/runningman84/charts/s3-resource-operator --version 1.13.2`
